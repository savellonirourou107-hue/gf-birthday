...
// 长信内容
const letterText = `小团，生日快乐！

今天不是什么大年大节，但因为是你的生日，这个普通的日子就变得不一样了。

二十岁了呢。二十岁听起来多好啊——不再是十几岁的末尾，是真正迈向新的一段的起点了。以前总觉得二十岁是很遥远的事，现在你站在这里了，是不是觉得也还好？日子是慢慢走的，但回头看，每一步都踩得实实的。

二十岁是什么样的年纪，我没有很确切的答案。但我喜欢《礼记》里古人给年岁命名的习惯——好像一旦立了名目，那段光阴便有了重量。你的二十岁，已经有了名字：它是你认真备考的冬天，是你和朋友大笑的夜晚，是我们隔着屏幕互相吐槽然后又互相打气的每一天。

你在潇湘边，我在燕山下。这两个地名之间的距离，我从来没有认真算过，只是知道，无论谁先出发，都要在火车上睡一觉，醒来窗外的风景已经全然换了样子。南方的山是水洗过的绿，北方的天是一整块干净的蓝。你看，我们各自占着祖国最好看的两种颜色，也不算亏。

我们相识于某年秋天的高中校园。那时候谁能想到呢？这个相识会走这么远。有些缘分是很漫长的展开，像《蒹葭》里那句"溯洄从之，道阻且长"——路是不好走的，但走着走着，也就走到了现在。这件事本身，就很值得高兴。

现在是期末周。你在岳麓山下背书，我在这里对着屏幕敲字。不能说太多话，各自都被一堆事追着跑。但陶渊明说"此中有真意，欲辨已忘言"——有些东西本来就藏在日子的缝隙里，不用刻意去说，它也在那里好好的。

见面总在假期。每次见了面又分开，总觉得时间太短。但后来我发现，不在一起的时候，我们会把各自看见的东西攒下来——你在湘江边拍到的傍晚，我在北方清早撞见的星空——然后见面的时候一件一件掏出来讲。这其实比一直待在一起还有意思。一个人愿意把只有自己见过的东西说给你听，是因为觉得你值得。这怎么不算一种拥有呢？

二十岁。我见证了其中几年，觉得是件很幸运的事。往后的年岁，还想慢慢见证下去。

期末周没有什么很好的礼物，也写不出什么惊人的句子。只是在某一个夜里，想起今天是你的生日，想把这些话写下来。
